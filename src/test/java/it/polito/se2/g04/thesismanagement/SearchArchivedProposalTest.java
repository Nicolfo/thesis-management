...
public class SearchArchivedProposalTest {
    ...
    public void setup() throws Exception {
        ...
        p1.setStatus(Proposal.Status.ARCHIVED);
        ...
        p2.setStatus(Proposal.Status.ARCHIVED);
        ...
        p3.setStatus(Proposal.Status.ARCHIVED);
    ...
    public void searchWithAllFields() throws Exception {
        ...
        req.setCds(p1.getCds());
        req.setNotes(p1.getNotes());

        ObjectMapper objectMapper = new ObjectMapper();
        String reqJson = objectMapper.writeValueAsString(req);

        MvcResult res = mockMvc.perform(MockMvcRequestBuilders.post("/API/proposal/searchArchived")
