...
public class BrowseProposalTest {
    ...
    mockMvc.perform(MockMvcRequestBuilders.post("/API/proposal/insert/")
        ...
        Proposal proposal4 = new Proposal(4L, "Proposal 4", teacher, null, "keywords", "type", null, "Description 2", "requiredKnowledge", "notes", null, "level", "CdS", null);
    ...
    public void testGetProposalsByProf() throws Exception {
        Proposal proposal1 = new Proposal(1L, "Proposal 1", teacher, null, "keywords", "type", null, "Description 1", "requiredKnowledge", "notes", null, "level", "CdS", null);
        Proposal proposal2 = new Proposal(2L, "Proposal 2", teacher, null, "keywords", "type", null, "Description 2", "requiredKnowledge", "notes", null, "level", "CdS", null);
        ...
        Proposal proposal3 = new Proposal(3L, "Proposal 3", otherTeacher, null, "keywords", "type", null, "Description 3", "requiredKnowledge", "notes", null, "level", "CdS", null);
        Proposal proposal4 = new Proposal(4L, "Proposal 4", teacher, List.of(teacher), "keywords", "type", null, "Description 4", "requiredKnowledge", "notes", null, "level", "CdS", null);
        proposalRepository.save(proposal3);
        proposalRepository.save(proposal4);
        ...
        proposalRepository.deleteAll();
        proposal1 = new Proposal(1L, "Proposal 1", otherTeacher, null, "keywords", "type", null, "Description 1", "requiredKnowledge", "notes", null, "level", "CdS", null);
        proposal2 = new Proposal(2L, "Proposal 2", otherTeacher, List.of(otherTeacher), "keywords", "type", null, "Description 2", "requiredKnowledge", "notes", null, "level", "CdS", null);
        proposalRepository.save(proposal1);
        proposalRepository.save(proposal2);
