...
public class EmailServiceImpl implements EmailService {
    ...
    public void notifyStudentOfApplicationDecision(Application application) {
        ...
        message.setText(EmailConstants.GREETING_FORMULA + " " + student.getName() + " " + student.getSurname() + ", \n" +
                "\n" +
    ...
    public void notifySupervisorOfNewApplication(Application application) {
        ...
        message.setText(EmailConstants.GREETING_FORMULA + " " + teacher.getName() + " " + teacher.getSurname() + ", \n" +
                "\n" +
