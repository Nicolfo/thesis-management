...
const getNotPendingProposalOnRequestsByTeacher = async (jwt) => {
    return getJson(fetch(SERVER_URL + "proposalOnRequest/getByTeacherNotPending", {
        method: 'GET',
        headers:{
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${jwt}`,
...
const getProposalOnRequestsByCoSupervisor = async (jwt) => {
    return getJson(fetch(SERVER_URL + "proposalOnRequest/getByCoSupervisor", {
        method: 'GET',
        headers:{
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${jwt}`,
...
const updateRequest = async (request, jwt) => {
    return fetch(`${SERVER_URL}proposalOnRequest/makeChanges/${request.id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${jwt}`
...
const getProposalsByCoSupervisor = async (jwt) => {
    return getJson(fetch(SERVER_URL + 'proposal/getAllProposalByCoSupervisor/', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${jwt}`,
